// Shared, server-side store for the owners' selection on /scope/ (HOAhx · Beyond the proposal).
// Backed by Netlify Blobs (site-wide store "hoahx-scope"); no external database. Same shape and
// rules as decisions.js: one blob per package or feature, history kept, nothing ever deleted.
//
//   GET  /api/picks          -> { "<id>": { v, n, code, updatedAt }, ... }   (live picks, notes, the message, the last submission)
